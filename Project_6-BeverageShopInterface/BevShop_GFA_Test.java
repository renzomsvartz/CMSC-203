...
public class BevShop_GFA_Test 
{
	...
	public void testProcessAlcoholOrder()
	{
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(0).getType().equals(TYPE.ALCOHOLIC));	
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(1).getType().equals(TYPE.ALCOHOLIC));	
		assertTrue(bevShop.eligibleForMore());
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(2).getType().equals(TYPE.ALCOHOLIC));	
